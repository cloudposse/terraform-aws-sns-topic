...
| <a name="input_delivery_status"></a> [delivery\_status](#input\_delivery\_status) | Enable Message delivery status for the various SNS subscription endpoints.<br/>The success\_role\_arn and failure\_role\_arn arguments are used to give Amazon SNS write<br/>access to use CloudWatch Logs on your behalf.<br/>The success\_sample\_rate argument is for specifying the sample rate percentage (0-100) of<br/>successfully delivered messages. | <pre>object({<br/>    application = object({<br/>      success_role_arn    = string<br/>      failure_role_arn    = string<br/>      success_sample_rate = number<br/>    })<br/>    firehose = object({<br/>      success_role_arn    = string<br/>      failure_role_arn    = string<br/>      success_sample_rate = number<br/>    })<br/>    http = object({<br/>      success_role_arn    = string<br/>      failure_role_arn    = string<br/>      success_sample_rate = number<br/>    })<br/>    lambda = object({<br/>      success_role_arn    = string<br/>      failure_role_arn    = string<br/>      success_sample_rate = number<br/>    })<br/>    sqs = object({<br/>      success_role_arn    = string<br/>      failure_role_arn    = string<br/>      success_sample_rate = number<br/>    })<br/>  })</pre> | `{}` | no |
